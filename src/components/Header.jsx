function Header() {
  return (
    <header className="border-b border-slate-700/60 bg-slate-900/80 px-6 py-4 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3 py-1">
          ...
          <span className="text-sm text-emerald-400">Monitorização ativa</span>
        </div>
      </div>
    </header>
  )
